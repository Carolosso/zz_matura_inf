...
public class zad20 {
	...
	public static boolean narcystyczna(String liczba,int system) {
		...
		//jesli spelniony jest warunek narcystycznosci czyli obie sumy sa rowne liczbie dziesietnej
		if((suma1==Integer.parseInt(liczba))&&(suma2==Integer.parseInt(liczba)))return true;
		else return false;
