		...
		while (wybor != 9) {
			...
			switch (wybor) {
				...
				case 1: {
					...
					System.out.println("2. Wyswietl iloœæ liczb spelniajacych warunek");
					widok = s.nextInt();
					if (widok == 1) {
						System.out.println(
								"Liczby, w których rozk³adzie na czynniki pierwsze wystêpuj¹ dok³adnie trzy ró¿ne czynniki z których ka¿dy jest nieparzysty: ");
				...
				case 2: {
					...
					if (widok == 1) {
						...
						System.out.println("Iloœæ liczb, w ktorych zapis dziesietny jest palindromem: " + licznik_pali);
					} else
						System.out.println("ERROR");
					break;
				}
				case 3: {
					...
					if (moc >= 1 && moc <= 8) {
						...
						if (widok == 1) {
							...
							System.out.println("Iloœæ liczb o mocy " + moc + ": " + licznik_moc);
						} else
							System.out.println("ERROR");
						break;
					} else
